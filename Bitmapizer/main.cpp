...
//    string bmpPath = fs::path("/Users/fsjolander/Documents/JTH/VT_2022/Bachelor_Thesis/Applications/AMOCR-web/web-app/src/presentation-layer/public/meter-images");
//
//    // To which folder to save the colour depth reduced bmp files:
//    string reducedDestinationPath = fs::path("/Users/fsjolander/Documents/JTH/VT_2022/Bachelor_Thesis/Applications/AMOCR-Bitmapizer/testfolder");
//
//
//    Bitmap bmp2(bmpPath);
//    FileManager fm2(bmpPath, reducedDestinationPath);
//
